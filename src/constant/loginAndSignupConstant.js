...
export const HEADER_LABEL5 ='Already have an account?'
export const HEADER_LABEL6 ="Don't have an account?"
export const HEADER_LABEL4 ='Sign Up'
export const INPUT_LABEL3='Email'
